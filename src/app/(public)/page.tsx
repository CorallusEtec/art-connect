...
export default function LandindPage() {
  ...
  return (
    <>
      ...
      <section id="banner">
        <div
          className="min-h-60 inset-shadow-md bg-contain flex items-center justify-center"
          style={{ backgroundImage: "url('assets/bg/fundo.png')" }}
        >
          <h1 className="text-white font-semibold text-5xl">
            Conectando talentos à oportunidades reais
          </h1>
        </div>
      </section>
          ...
          <div className="flex flex-col col-span-2 gap-10 p-7">
            ...
            <div className="flex justify-end">
              <div className="flex flex-col gap-4 w-3/4">
                <h3 className="font-semibold text-3xl text-azul-600">
                  O que é o Art Connect?
                </h3>
                <p className="w-4/5 font-light text-xl text-azul-500">
                  O Art Connect é um aplicativo que conecta artistas a
                  contratantes por meio de portfólios personalizados e busca
                  avançada por perfil
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center">
              <img
                className="shadow-xl/20 border border-cinza-100 rounded-4xl aspect-square w-1/6"
                src="/assets/icons/splash-icon.png"
                alt="Icone Art Connect"
              />
              <img
                className="aspect-5/2 w-1/4"
                src="/assets/icons/nameBanner.png"
                alt="Art Connect"
              />
              {/* DOWNLOAD */}
              <div className="flex gap-5">
                <img
                  src="/assets/icons/publisher/gplay.svg"
                  alt="Google Play Store"
                />
                <img
                  src="/assets/icons/publisher/appleStore.svg"
                  alt="Google Play Store"
                />
              </div>
            </div>
      ...
      <section id="app" className="mb-30">
        ...
        <div className="flex flex-col mb-20 items-center gap-3">
          <h2 className="font-medium text-azul-700 text-4xl">
            Conheça o Aplicativo
          </h2>
          {/* BOTÕES DE FUNCIONALIDADES */}
          <div className="flex gap-5">
            <ButtonSelect
              onClick={() => setOption("busca")}
              selected={option == "busca"}
              title="Busca"
            />

            <ButtonSelect
              onClick={() => setOption("portifolio")}
              selected={option == "portifolio"}
              title="Portifólio"
            />

            <ButtonSelect
              onClick={() => setOption("contatos")}
              selected={option == "contatos"}
              title="Contatos"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-6">
          ...
          <div className="col-span-3">
            <div className="flex justify-center">
              <img
                className="w-70 h-150 p-1 shadow-xl/40 rounded-4xl"
                src={features[option].img}
                alt="App Art Connect"
              />
            </div>
          </div>
