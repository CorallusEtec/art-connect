                ...
                <div className="flex flex-col p-5 w-[75%]">
                    ...
                    <div className="flex flex-col mb-3 gap-4">
                        ...
                        <div className=" flex flex-row border text-xl rounded-lg border-stone-300 gap-1.5 p-2 bg-stone-200">
                            ...
                            <input type="password" className="text-lg w-full outline-none" placeholder="Senha" />
                            <button>
                    ...
                    <div className="flex justify-between mb-10">
                        <div className="flex gap-2">
                            <input type="checkbox" className="accent-emerald-600" name="" id="" />
                    ...
                    {/* BOTÕES */}
                     <div className="flex flex-col items-center gap-5">
                        <a className="w-[50%] rounded-lg bg-teal-400 border border-teal-600 text-white p-2 text-center" href="">Entrar</a>
                        <a className="w-[50%] rounded-lg bg-white border border-teal-600 text-teal-600 p-2 text-center" href="">Entrar sem Login</a>
                     </div>
                </div>
            </div>
